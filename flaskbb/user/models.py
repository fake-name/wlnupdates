...
from flaskbb.forum.models import (Posts, Topic, topictracker, TopicsRead,
								  ForumsRead)
...
class Users(db.Model, UserMixin):
	...
	def last_post(self):
		...
		return Posts.query.filter(Posts.user_id == self.id).\
			order_by(Posts.date_created.desc()).first()
